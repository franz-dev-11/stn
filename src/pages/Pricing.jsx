  ...
  return (
    <div className='min-h-screen bg-[#f8fafc] p-8'>
      <h1 className='text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3'>
        <Tag className='text-teal-600' size={32} /> EDIT PRICING
      </h1>
      <p className='text-slate-600 font-bold text-xs uppercase tracking-[0.2em] mt-2 mb-10'>
        ...
        <table className='w-full text-left'>
          <thead>
            <tr className='bg-black text-white text-[10px] font-black uppercase'>
              ...
              <th className='px-6 py-4'>Suggested SRP</th>
            ...
            {pricingData.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <td className='p-6 bg-teal-50/10'>
                    {isEditing ? (
                      <input
                        type='number'
                        className='w-24 border-2 border-teal-400 rounded p-2 font-black text-sm text-black outline-none bg-white'
